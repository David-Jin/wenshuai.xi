...
copy_api=
RELEASEDIR=../../release/i2/${board}/glibc/4.8.3/bin/kernel/spinand
RELEASEDIR_NOR=../../release/i2/${board}/glibc/4.8.3/bin/kernel/nor
RELEASEDIR_MODULES=../../release/i2/${board}/glibc/4.8.3/lib/modules/3.18.30
TMP=.
...
cp ${kl_dir}/.config  ${TMP}/configs/i2/${board}/glibc/ -v
cp ${kl_dir}/Module.symvers  ${TMP}/configs/i2/${board}/glibc/ -v
cp ${kl_dir}/include/config/auto.conf ${TMP}/configs/i2/${board}/glibc/include/config -v
cp -Rf ${kl_dir}/include/generated ${TMP}/configs/i2/${board}/glibc/include/

cp ${kl_dir}/.config  ${TMP}/configs/i2/${board}/glibc-squashfs/ -v
cp ${kl_dir}/Module.symvers  ${TMP}/configs/i2/${board}/glibc-squashfs/ -v
cp ${kl_dir}/include/config/auto.conf ${TMP}/configs/i2/${board}/glibc-squashfs/include/config -v
cp -Rf ${kl_dir}/include/generated ${TMP}/configs/i2/${board}/glibc-squashfs/include/

sed -i "s/CONFIG_CROSS_COMPILE=\""/CONFIG_CROSS_COMPILE=\"arm-linux-gnueabihf-"/g" "${TMP}/configs/i2/${board}/glibc/include/config/auto.conf"
...
if [ -e ${kl_dir}/arch/${arch}/boot/uImage ]
then
...
cp -f ${kl_dir}/modules/ntfs.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/cifs.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/nls_utf8.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/grace.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/sunrpc.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/lockd.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/ext2.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/fat.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/vfat.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/msdos.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/nfs.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/nfsv2.ko ${RELEASEDIR_MODULES}
cp -f ${kl_dir}/modules/mdrv-sata-host.ko ${RELEASEDIR_MODULES}
...
rm -Rf drivers/mstar/include/MsTypes.h
