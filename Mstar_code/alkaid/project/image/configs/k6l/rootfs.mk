...
rootfs:
	...
	tar xf $(PROJ_ROOT)/release/$(CHIP)/$(BOARD)/$(TOOLCHAIN)/$(TOOLCHAIN_VERSION)/lib/package/$(LIBC).tar.gz -C $(OUTPUTDIR)/rootfs
	...
	find $(PROJ_ROOT)/release/$(CHIP)/$(BOARD)/$(TOOLCHAIN)/$(TOOLCHAIN_VERSION)/lib/modules/$(KERNEL_VERSION) -name "*.ko" -exec cp {} $(OUTPUTDIR)/rootfs/lib/modules/$(KERNEL_VERSION) \;
